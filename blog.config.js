...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '17Q8', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '💪努力成为全能型媒体人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, blog, TikTok', // 网站关键词 英文逗号隔开
